...
public class ReceiptTest {
  ...
  private PurchasedItem item2 = new PurchasedItem(1);
  ...
  private void setup() {
    ...
    List<PurchasedItem> items = Arrays.asList(item, item2);
    receipt.setPurchasedItem(items);
    ...
    purchasedRepo.saveAndFlush(item2);
  }
